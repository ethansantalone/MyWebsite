            ...
            <div className="App-header">
                ...
                <div className="App-header-description">
                    ...
                    <div className="App-header-description-links">
                        <div className="App-header-description-links-individual" onClick={() => { window.open("https://linkedin.com/in/ethansantalone") }}>
                            <img src={linkedin_icon} className="linkedin" alt="linkedin_icon" />
                        </div>
                        <div className="App-header-description-links-individual" onClick={() => { window.open("https://github.com/ethansantalone") }}>
                        ...
                        <div className="App-header-description-links-individual" onClick={() => { window.open("https://instagram.com/ethansantalone") }}>
